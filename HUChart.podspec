#
#  Be sure to run `pod spec lint HUChart.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "" => "hoangnm.53@gmail.com", "other author" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/hugo53/HUChart.git", :tag => "0.0.1" }
